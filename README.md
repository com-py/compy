...
- ## Sep. 2017: Updated input() function compatibility between Python 2.xx and 3.xx to affected programs. Now all codes (.py and .ipynb) should run under Python 2.7x and 3.xx, with or without vpython. Original versions can be found in `v1.0` folder.
